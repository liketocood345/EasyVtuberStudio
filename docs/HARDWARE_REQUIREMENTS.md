# EasyVtuberStudio — 硬件需求评估 / Hardware Requirements
...
| **EasyVtuberStudio 面捕增强版** | `experiments/puppeteer_load_preview/character_model_mediapipe_puppeteer_load_preview.py` |
...
| 维度 | 原版 Puppeteer | EasyVtuberStudio 面捕增强版 | 差异说明 |
|------|----------------|-------------------------|----------|
...
本节说明 **THA4 MediaPipe Puppeteer 实际在算什么**，便于判断「12 GB 显存」到底是指 **EasyVtuberStudio 本身**，还是指 **直播整机方案**。
