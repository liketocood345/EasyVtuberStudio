...
2. You prepare a black-and-white mask image that covers the eyes and the mouth of the character. Use `distiller_ui` to preview the face crop and mask requirements.
