...
> **新 Agent 请先读仓库根目录 [../HANDOVER.md](../HANDOVER.md)**，再按需打开下表。

| 文件 | 说明 |
|------|------|
| [../HANDOVER.md](../HANDOVER.md) | **主入口**：路径、进度、验收、功能索引 |
| [layer-runtime-replan_3a393fc1.plan.md](layer-runtime-replan_3a393fc1.plan.md) | 多图层 L0–L3 总计划 |
