...
See `layer-runtime-replan_3a393fc1.plan.md` todos `L0-external-output-toggle` and `L0-external-output-bridge`.

## 8) Known limitations / TODOs (recommended next work)
