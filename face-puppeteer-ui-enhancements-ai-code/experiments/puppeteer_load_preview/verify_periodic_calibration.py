...
class ScaleCalibrationHarness:
    """Mirrors MainFrame display neutral scale periodic calibration."""
...
def test_scale_preserves_center():
    h = ScaleCalibrationHarness()
    h.set_neutral_face_screen_motion(FaceScreenMotion(0.1, 0.2, 0.4))
    h.update_neutral_face_size(FaceScreenMotion(0.9, 0.8, 0.7))
    assert_close(h.neutral_face_screen_motion.center_x, 0.1)
